...
if __name__ == '__main__':
    ...
    # for each record in bbox file, do the following:
    while idx < len(bbox_line_list):
        ...
        while True:
            ...
            # DEAL WITH MULTIPLE DETECTION RESULT FOR ONE FRAME.
            # Peek next frame detection, if the following detection
            # result is also for the same frame, then continue,
            # otherwise, break.
            try:
                next_frame_num = int(
                ...
                print "Reach the last frame of the video sequence."
                break
