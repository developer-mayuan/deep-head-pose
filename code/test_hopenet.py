...
def parse_args():
    ...
    parser.add_argument('--batch_size', dest='batch_size', help='Batch size.',
                        default=1, type=int)
    parser.add_argument('--save_viz', dest='save_viz',
    ...
    for i, (images, labels, cont_labels, name) in enumerate(test_loader):
        ...
        if args.save_viz:
            ...
            if args.batch_size == 1:
                ...
                cv2.putText(cv2_img, error_string, (30, cv2_img.shape[0] - 30),
            ...
            utils.draw_axis(cv2_img, yaw_predicted[0], pitch_predicted[0],
