...
def parse_args():
    ...
    parser.add_argument('--dataset', dest='dataset', help='Dataset type.',
...
if __name__ == '__main__':
    ...
    for epoch in range(num_epochs):
        for i, (images, labels, cont_labels, name) in enumerate(
                train_loader):
            ...
            loss_reg_pitch = reg_criterion(pitch_predicted,
                                           label_pitch_cont)
            ...
            if (i + 1) % 100 == 0:
                print (
                        ...
                        % (epoch + 1, num_epochs, i + 1,
                           ...
                           loss_yaw.data[0], loss_pitch.data[0],
                           loss_roll.data[0]))
        ...
        if epoch % 1 == 0 and epoch < num_epochs:
            ...
            torch.save(model.state_dict(),
                       'output/snapshots/' + args.output_string + '_epoch_' + str(
                           epoch + 1) + '.pkl')
